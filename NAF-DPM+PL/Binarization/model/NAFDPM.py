#NAFDPM.py
"""
This file defines the NAFDPM (NAFNet-based Diffusion Probabilistic Model) class, which integrates the ConditionalNAFNet with a diffusion model for document enhancement.

NAFDPM: The main class that combines an initial predictor (NAFNet) and a denoiser (ConditionalNAFNet) for training and inference. The diffusion process is used to refine the initial prediction.
EMA: A class for maintaining an exponential moving average of model parameters, which helps in stabilizing training.S
"""
import torch
